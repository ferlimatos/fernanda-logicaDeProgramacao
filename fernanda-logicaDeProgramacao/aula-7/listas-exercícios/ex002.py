...
print(f"a. O maior número é: {maior_numero}")

menor_numero = min(numeros)
print(f"b. O menor número é: {menor_numero}")

soma_dos_numeros = sum(numeros)
print(f"c. A soma dos números é: {soma_dos_numeros}")

quantidade = len(numeros)
media = soma_dos_numeros / quantidade

print(f"d. A média dos números é: {media:.2f}")